package fr.stylobow.iyn.client;

import fr.stylobow.iyn.client.renderer.CustomCapeLayer;
...
@EventBusSubscriber(modid = "iyn", bus = EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
