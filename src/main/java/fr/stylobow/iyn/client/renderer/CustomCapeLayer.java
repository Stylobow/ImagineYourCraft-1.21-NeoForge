package fr.stylobow.iyn.client.renderer;
...
public class CustomCapeLayer extends RenderLayer<AbstractClientPlayer, PlayerModel<AbstractClientPlayer>> {
    ...
    private static final ResourceLocation CAPE_LOCATION = ResourceLocation.fromNamespaceAndPath("iyn", "textures/cape/capehdpinkpotatov2.png");

    private static final String OWNER_UUID = "ef3a9cb5-3544-4ba3-b0f5-2fe19d2363be";
    ...
    public void render(
        ...
        if (!livingEntity.getUUID().toString().equals(OWNER_UUID)) {
            return;
        }
        ...
        if (!livingEntity.isInvisible() && livingEntity.isModelPartShown(PlayerModelPart.CAPE)) {
            ...
            if (!itemstack.is(Items.ELYTRA)) {
                ...
                VertexConsumer vertexconsumer = buffer.getBuffer(RenderType.entitySolid(CAPE_LOCATION));
